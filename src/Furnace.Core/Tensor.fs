...
/// <remarks>
/// <para>This type represents the most generic definition of a new op representing a unary function, allowing the specification of: (1) the <see cref="T:Furnace.Backends.RawTensor"/> operation, (2) the derivative propagation rule for the forward differentiation mode and (3) the derivative propagation rule for the reverse differentiation mode.</para>
/// <para>In general, if you are implementing a simple elementwise op, you should prefer using the <see cref="T:Furnace.UnaryOpElementwise"/> type, which is much simpler to use.</para>
/// </remarks>
/// <example>
/// <code>
...
/// <remarks>
/// <para>This type is specialized to elementwise ops. It requires the user to specify only (1) the <see cref="T:Furnace.Backends.RawTensor"/> operation and (2) the derivative of the function with respect to its argument. The corresponding derivative propagation rules for the forward and reverse differentiation modes are automatically generated.</para>
/// <para>If you are implementing a complex op that is not elementwise, you can use the generic type <see cref="T:Furnace.UnaryOp"/>, which allows you to define the full derivative propagation rules.</para>
/// </remarks>
/// <example>
/// <code>
...
/// <para>In general, if you are implementing a simple elementwise op, you should prefer using the <see cref="T:Furnace.BinaryOpElementwise"/> type, which is much simpler to use.</para>
/// </remarks>
/// <example>
/// <code>
...
/// <para>If you are implementing a complex op that is not elementwise, you can use the generic type <see cref="T:Furnace.BinaryOp"/>, which allows you to define the full derivative propagation rules.</para>
/// </remarks>
/// <example>
/// <code>
