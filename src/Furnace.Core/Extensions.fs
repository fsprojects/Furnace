...
///
/// <namespacedoc>
///   <summary>Contains utilities and library extensions related to the Furnace programming model.</summary>
/// </namespacedoc>
module Array =
...
[<assembly: System.Runtime.CompilerServices.InternalsVisibleTo("Furnace.Tests")>]
do()
