...
type TestTensorConvolutions () =
    ...
    member _.TestTensorConv1D () =
        for combo in Combos.FloatingPointExcept16s do 
            ...
            let t3 = FurnaceImage.conv1d(t1, t2)
            ...
            let t3p1 = FurnaceImage.conv1d(t1, t2, padding=1)
            ...
            let t3p2 = FurnaceImage.conv1d(t1, t2, padding=2)
            ...
            let t3s2 = FurnaceImage.conv1d(t1, t2, stride=2)
            ...
            let t3s3 = FurnaceImage.conv1d(t1, t2, stride=3)
            ...
            let t3s2p1 = FurnaceImage.conv1d(t1, t2, stride=2, padding=1)
            ...
            let t3s3p2 = FurnaceImage.conv1d(t1, t2, stride=3, padding=2)
            ...
            let t3d2 = FurnaceImage.conv1d(t1, t2, dilation=2)
            ...
            let t3p2d3 = FurnaceImage.conv1d(t1, t2, padding=2, dilation=3)
            ...
            let t3s3p6d3 = FurnaceImage.conv1d(t1, t2, stride=3, padding=6, dilation=3)
        ...
        for dtype1 in Dtypes.All do 
            for dtype2 in Dtypes.All do 
                if dtype1 <> dtype2 then 
                    let x = FurnaceImage.zeros([1;4;4], dtype=dtype1)
                    let y = FurnaceImage.zeros([1;4;4], dtype=dtype2)
                    isException(fun () -> FurnaceImage.conv1d(x,y))

        for combo in Combos.Bool do 
            let x = combo.zeros([1;4;4])
            let y = combo.zeros([1;4;4])
            isInvalidOp(fun () -> FurnaceImage.conv1d(x,y))
    ...
    member _.TestTensorConv2D () =
        for combo in Combos.FloatingPointExcept16s do 
            ...
            let t3 = FurnaceImage.conv2d(t1, t2)
            ...
            let t3p1 = FurnaceImage.conv2d(t1, t2, padding=1)
            ...
            let t3p12 = FurnaceImage.conv2d(t1, t2, paddings=[|1; 2|])
            ...
            let t3s2 = FurnaceImage.conv2d(t1, t2, stride=2)
            ...
            let t3s13 = FurnaceImage.conv2d(t1, t2, strides=[|1; 3|])
            ...
            let t3s2p1 = FurnaceImage.conv2d(t1, t2, stride=2, padding=1)
            ...
            let t3s23p32 = FurnaceImage.conv2d(t1, t2, strides=[2; 3], paddings=[3; 2])
            ...
            let t3p1d2 = FurnaceImage.conv2d(t1, t2, padding=1, dilation=2)
            ...
            let t3p22d23 = FurnaceImage.conv2d(t1, t2, paddings=[2;2], dilations=[2;3])
            ...
            let t3s3p6d3 = FurnaceImage.conv2d(t1, t2, stride=3, padding=6, dilation=3)
        ...
        for dtype1 in Dtypes.All do 
            for dtype2 in Dtypes.All do 
                if dtype1 <> dtype2 then 
                    let x = FurnaceImage.zeros([1;1;4;4], dtype=dtype1)
                    let y = FurnaceImage.zeros([1;1;4;4], dtype=dtype2)
                    isException(fun () -> FurnaceImage.conv2d(x,y, strides=[1;1]))

        for combo in Combos.Bool do 
            let x = combo.zeros([1;1;4;4])
            let y = combo.zeros([1;1;4;4])
            isInvalidOp(fun () -> FurnaceImage.conv2d(x,y, strides=[1;1]))
    ...
    member _.TestTensorConv3D () =
        for combo in Combos.FloatingPointExcept16s do 
            ...
            let t3 = FurnaceImage.conv3d(t1, t2)
            ...
            let t3p1 = FurnaceImage.conv3d(t1, t2, padding=1)
            ...
            let t3p123 = FurnaceImage.conv3d(t1, t2, paddings=[|1; 2; 3|])
            ...
            let t3s2 = FurnaceImage.conv3d(t1, t2, stride=2)
            let t3s2Correct = combo.tensor([[[[3.1109]]]]).unsqueeze(0)

            let t3s132 = FurnaceImage.conv3d(t1, t2, strides=[|1; 3; 2|])
            let t3s132Correct = combo.tensor([[[[3.1109]],
                                                  [[5.0324]]]]).unsqueeze(0)

            let t3s2p1 = FurnaceImage.conv3d(t1, t2, stride=2, padding=1)
            ...
            let t3s231p321 = FurnaceImage.conv3d(t1, t2, strides=[2; 3; 1], paddings=[3; 2; 1])
            ...
            let t3p1d2 = FurnaceImage.conv3d(t1, t2, padding=1, dilation=2)
            ...
            let t3p224d234 = FurnaceImage.conv3d(t1, t2, paddings=[2;2;4], dilations=[2;3;4])
            ...
            let t3s3p6d3 = FurnaceImage.conv3d(t1, t2, stride=3, padding=6, dilation=3)
            let t3s3p6d3Correct = 
    ...
    member _.TestTensorConvTranspose1D () =
        for combo in Combos.FloatingPointExcept16s do
            ...
            let t3 = FurnaceImage.convTranspose1d(t1, t2)
            ...
            let t3s3 = FurnaceImage.convTranspose1d(t1, t2, stride=3)
            ...
            let t3s2p1 = FurnaceImage.convTranspose1d(t1, t2, stride=2, padding=1)
            ...
            let t3s3p2 = FurnaceImage.convTranspose1d(t1, t2, stride=3, padding=2)
            ...
            let t3d2 = FurnaceImage.convTranspose1d(t1, t2, dilation=2)
            ...
            let t3p2d3 = FurnaceImage.convTranspose1d(t1, t2, padding=2, dilation=3)
            ...
            let t3s3p6d3 = FurnaceImage.convTranspose1d(t1, t2, stride=3, padding=6, dilation=3)
    ...
    member _.TestTensorConvTranspose2D () =
        for combo in Combos.FloatingPointExcept16s do
            ...
            let t3 = FurnaceImage.convTranspose2d(t1, t2)
            ...
            let t3p1 = FurnaceImage.convTranspose2d(t1p1, t2, padding=1)
            ...
            let t3p12 = FurnaceImage.convTranspose2d(t1p12, t2, paddings=[1;2])
            ...
            let t1s2 = combo.tensor([[[[-4.2302, -2.7939],
                                     ...
                                     [[[ 4.4355, -3.7308],
                                      ...
                                      [[-3.0583, -7.1895],
                                       [ 9.4745,  6.8794]]]])
            let t3s2 = FurnaceImage.convTranspose2d(t1s2, t2, stride=2)
            ...
            let t1s13 = combo.tensor([[[[-9.8044, -2.9782],
                                         ...
                                         [[[-3.0220,  2.2930],
                                          ...
                                          [[-1.8104, -8.8542],
                                           ...
                                           [ 1.1023,  0.6211],
                                           [ 0.3481, -3.1282]]]])
            let t3s13 = FurnaceImage.convTranspose2d(t1s13, t2, strides=[1;3])
            ...
            let t3s2p1 = FurnaceImage.convTranspose2d(t1s2p1, t2, stride=2, padding=1)
            ...
            let t3s23p32 = FurnaceImage.convTranspose2d(t1s23p32, t2, strides=[2;3], paddings=[3;2])
            ...
            let t3p1d2 = FurnaceImage.convTranspose2d(t1p1d2, t2, padding=1, dilation=2)
            ...
            let t3p22d23 = FurnaceImage.convTranspose2d(t1p22d23, t2, paddings=[2;2], dilations=[2;3])
            ...
            let t3s3p6d3 = FurnaceImage.convTranspose2d(t1s3p6d3, t2, stride=3, padding=6, dilation=3)
    ...
    member _.TestTensorConvTranspose3D () =
        for combo in Combos.FloatingPointExcept16s do
            ...
            let t3 = FurnaceImage.convTranspose3d(t1, t2)
            ...
            let t3p1 = FurnaceImage.convTranspose3d(t1, t2, padding=1)
            ...
            let t3p122 = FurnaceImage.convTranspose3d(t1, t2, paddings=[1; 2; 2])
            ...
            let t3s2 = FurnaceImage.convTranspose3d(t1, t2, stride=2)
            ...
            let t3s132 = FurnaceImage.convTranspose3d(t1, t2, strides=[1;3;2])
            ...
            let t3s2p1 = FurnaceImage.convTranspose3d(t1, t2, stride=2, padding=1)
            ...
            let t3p1d2 = FurnaceImage.convTranspose3d(t1, t2, padding=1, dilation=2)
